...
Presentación interactiva de **VerbaNexAI Lab** sobre _{{TITULO}}_.
...
3. **Levanta el servidor** desde la raíz del proyecto:
   ...
   npm start
   ```
4. **Abre la presentación**: http://localhost:3000/{{SLUG}}/
5. **Graba** con el botón ⏺ Grabar integrado (elige el modo según si vas a mostrar demos externas).
6. Las grabaciones se guardan automáticamente en `{{SLUG}}/media/` (excluida de git).
...
_Generado el {{FECHA}} con `node scripts/crear-presentacion.js`._
